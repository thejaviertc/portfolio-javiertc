				...
				<section id="header" className="fullpage bg-primary">
					<div className="container">
						<h1 className="text-center">
							Javiertc <i className="fa-solid fa-code"></i>
						</h1>
				...
				<section id="projects" className="bg-primary py-5">
					<div className="container">
						...
						<ProjectItem
							position="0"
							title="Twitch Data"
							desc="See the views and followers of your favourite Twitch Streamers!"
							badge="ReactJS"
							type="warning"
						...
						<ProjectItem
							...
							desc="See the views, subscriptions and favs of your Steam Workshop addons!"
							badge="ReactJS"
							type="warning"
